...
CFG = dict(rho=0.03, gamma=4, theta_init=0.25, decay=0.99, k0=20, eta_homeo=0.05)
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if vl < best:
            best = vl
            torch.save({"W": model.W, "theta": model.theta, "anchor": model.anchor, "cfg": CFG}, "model_v5_best.pt")

...
from model_v6 import SparsePatternLMv6
...
def main():
    ...
    model = SparsePatternLMv6(vocab_size=VOCAB, N=N, **CFG).to(device)
    print(f"cfg={CFG}")
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if vl < best:
            best = vl
            torch.save({"W": model.W, "theta": model.theta, "anchor": model.anchor, "cfg": CFG}, "model_v6_best.pt")
